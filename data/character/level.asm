...
; bytes 2-4 = experience points
              You'll have too add the together. No way around it. :(
; bytes 5-13 = stats
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	019, 015, 020, 028, 015, 013, 020, 012, 010, $10 
	
	dc.b	2		; Level
	dc.b	$00, $00, $1D	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 003, 005, 004, 003, 004, 004, 004, 003, $00 
	
	dc.b	3		; Level
	dc.b	$00, $00, $53	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 003, 005, 004, 003, 004, 004, 005, 004, $00 
	
	dc.b	4		; Level
	dc.b	$00, $00, $AA	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	009, 006, 013, 010, 008, 010, 010, 007, 005, $01 
	
	dc.b	5		; Level
	dc.b	$00, $01, $21	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 003, 005, 004, 003, 004, 004, 004, 003, $20 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 003, 005, 004, 003, 004, 004, 006, 005, $11 
	
	dc.b	8		; Level
	dc.b	$00, $04, $EC	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	009, 006, 013, 010, 008, 010, 010, 007, 006, $11 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 003, 005, 004, 003, 004, 004, 005, 004, $10 
	
	dc.b	11		; Level
	dc.b	$00, $11, $17	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 003, 005, 004, 003, 004, 004, 006, 005, $10 
	
	dc.b	12		; Level
	dc.b	$00, $19, $68	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	009, 006, 013, 010, 008, 010, 010, 007, 006, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 003, 005, 004, 003, 004, 004, 006, 005, $00 
	
	dc.b	16		; Level
	dc.b	$00, $76, $DB	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	009, 006, 013, 010, 008, 010, 010, 007, 006, $21 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	009, 006, 013, 010, 008, 010, 010, 007, 006, $10 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 003, 005, 004, 003, 004, 004, 005, 004, $01 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	009, 006, 012, 010, 008, 010, 010, 007, 006, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	009, 006, 014, 010, 008, 010, 010, 007, 006, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	012, 010, 014, 018, 027, 010, 014, 007, 012, $11 
	
	dc.b	2		; Level
	dc.b	$00, $00, $0C	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	004, 002, 002, 001, 002, 001, 001, 002, 002, $00 
	
	dc.b	3		; Level
	dc.b	$00, $00, $19	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	004, 002, 002, 001, 002, 001, 001, 002, 001, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 004, 015, 009, 002, 010, 010, 006, 005, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 004, 015, 009, 002, 010, 010, 006, 005, $01 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	004, 002, 002, 001, 002, 001, 001, 002, 002, $11 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 004, 015, 009, 002, 010, 010, 006, 005, $11 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	004, 001, 002, 001, 001, 001, 001, 002, 001, $00 
	
	dc.b	36		; Level
	dc.b	$01, $38, $CE	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	004, 002, 002, 001, 001, 001, 001, 002, 002, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 006, 015, 009, 008, 010, 010, 006, 005, $00 
	
	dc.b	41		; Level
	dc.b	$03, $13, $AE	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	004, 001, 002, 001, 001, 001, 001, 002, 002, $00 
	
	dc.b	42		; Level
	dc.b	$03, $91, $8F	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	004, 002, 002, 001, 001, 001, 001, 002, 001, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	004, 002, 002, 001, 001, 001, 001, 001, 002, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	044, 000, 060, 028, 015, 007, 012, 010, 012, $00 
	
	dc.b	2		; Level
	dc.b	$00, $00, $20	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 000, 004, 003, 003, 002, 003, 004, 007, $00 
	
	dc.b	3		; Level
	dc.b	$00, $00, $5B	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 000, 013, 006, 006, 008, 006, 005, 008, $00 
	
	dc.b	4		; Level
	dc.b	$00, $00, $BA	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 000, 004, 003, 003, 002, 003, 003, 006, $00 
	
	dc.b	5		; Level
	dc.b	$00, $01, $3C	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	008, 000, 004, 003, 003, 002, 003, 004, 007, $00 
	
	dc.b	6		; Level
	dc.b	$00, $02, $27	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	009, 000, 013, 006, 006, 008, 006, 006, 008, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 000, 006, 003, 003, 002, 003, 003, 006, $00 
	
	dc.b	11		; Level
	dc.b	$00, $12, $AD	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	008, 000, 006, 003, 003, 002, 003, 004, 007, $00 
	
	dc.b	12		; Level
	dc.b	$00, $1B, $C3	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	009, 000, 009, 006, 006, 008, 006, 006, 008, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 000, 002, 003, 003, 002, 003, 003, 006, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	009, 000, 015, 006, 006, 008, 006, 006, 004, $00 
	
	dc.b	22		; Level
	dc.b	$02, $CD, $B3	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 000, 004, 003, 003, 002, 003, 003, 002, $00 
	
	dc.b	23		; Level
	dc.b	$03, $63, $79	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	008, 000, 004, 003, 003, 002, 003, 004, 003, $00 
	
	dc.b	24		; Level
	dc.b	$04, $0E, $A1	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	009, 000, 013, 006, 006, 008, 006, 006, 004, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	010, 018, 013, 024, 005, 008, 016, 007, 004, $11 
	
	dc.b	2		; Level
	dc.b	$00, $00, $23	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	005, 003, 003, 003, 002, 004, 003, 002, 002, $10 
	
	dc.b	3		; Level
	dc.b	$00, $00, $63	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 003, 006, 003, 004, 008, 007, 003, 003, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	005, 003, 003, 003, 002, 004, 003, 002, 003, $11 
	
	dc.b	6		; Level
	dc.b	$00, $02, $59	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 006, 006, 007, 004, 008, 007, 003, 003, $11 
	
	dc.b	7		; Level
	dc.b	$00, $03, $C5	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	005, 003, 003, 003, 002, 004, 003, 002, 002, $00 
	
	dc.b	8		; Level
	dc.b	$00, $05, $E0	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	005, 003, 003, 003, 002, 004, 003, 002, 003, $00 
	
	dc.b	9		; Level
	dc.b	$00, $09, $00	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 006, 006, 007, 004, 008, 017, 003, 003, $11 
	
	dc.b	10		; Level
	dc.b	$00, $0D, $A3	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	005, 003, 003, 003, 002, 004, 003, 002, 002, $11 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	005, 004, 003, 003, 002, 004, 003, 002, 003, $00 
	
	dc.b	15		; Level
	dc.b	$00, $60, $EF	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 005, 006, 007, 004, 008, 007, 003, 003, $21 
	
	dc.b	16		; Level
	dc.b	$00, $8D, $EB	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	005, 004, 003, 003, 002, 004, 003, 002, 002, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 006, 006, 007, 004, 008, 007, 003, 003, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	005, 003, 003, 003, 002, 006, 003, 002, 002, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 006, 006, 007, 004, 006, 007, 003, 003, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 006, 006, 007, 004, 008, 007, 003, 003, $10 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 005, 006, 007, 004, 008, 007, 003, 003, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	016, 019, 014, 026, 008, 006, 010, 007, 006, $00 
	
	dc.b	2		; Level
	dc.b	$00, $00, $22	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	004, 003, 003, 003, 002, 004, 002, 003, 003, $10 
	
	dc.b	3		; Level
	dc.b	$00, $00, $60	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 005, 007, 005, 004, 008, 007, 003, 003, $20 
	
	dc.b	4		; Level
	dc.b	$00, $00, $C5	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	005, 003, 003, 003, 002, 004, 002, 003, 003, $00 
	
	dc.b	5		; Level
	dc.b	$00, $01, $4F	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 003, 003, 003, 002, 004, 002, 003, 002, $20 
	
	dc.b	6		; Level
	dc.b	$00, $02, $48	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 005, 007, 005, 004, 008, 007, 003, 004, $10 
	
	dc.b	7		; Level
	dc.b	$00, $03, $A9	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	005, 003, 003, 003, 002, 004, 002, 003, 002, $00 
	
	dc.b	8		; Level
	dc.b	$00, $05, $B4	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 003, 003, 003, 002, 004, 002, 003, 002, $11 
	
	dc.b	9		; Level
	dc.b	$00, $08, $BD	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 004, 007, 005, 004, 008, 007, 003, 004, $10 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 003, 003, 003, 002, 004, 002, 003, 003, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 003, 003, 003, 002, 004, 002, 003, 002, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 004, 003, 003, 002, 004, 002, 003, 003, $00 
	
	dc.b	21		; Level
	dc.b	$02, $71, $6D	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 004, 007, 005, 004, 008, 007, 003, 003, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 000, 003, 003, 002, 004, 002, 003, 002, $00 
	
	dc.b	27		; Level
	dc.b	$06, $F6, $9D	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 007, 007, 005, 004, 008, 007, 003, 004, $10 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	005, 002, 003, 003, 002, 004, 002, 003, 003, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 002, 003, 003, 002, 004, 002, 003, 002, $00 
	
	dc.b	36		; Level
	dc.b	$16, $23, $9D	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 006, 007, 005, 004, 008, 007, 003, 004, $10 
	
	dc.b	37		; Level
	dc.b	$19, $04, $66	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	005, 002, 003, 003, 002, 004, 002, 003, 002, $00 
	
	dc.b	38		; Level
	dc.b	$1C, $44, $F8	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 002, 003, 003, 002, 004, 002, 003, 003, $00 
	
	dc.b	39		; Level
	dc.b	$1F, $F1, $C8	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 007, 007, 005, 004, 008, 007, 003, 003, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 005, 007, 005, 004, 008, 007, 003, 004, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 006, 007, 005, 004, 008, 007, 003, 003, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	018, 012, 020, 027, 020, 009, 015, 012, 011, $10 
	
	dc.b	2		; Level
	dc.b	$00, $00, $1F	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 002, 004, 002, 002, 003, 003, 003, 002, $00 
	
	dc.b	3		; Level
	dc.b	$00, $00, $58	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 001, 004, 002, 002, 003, 003, 003, 002, $00 
	
	dc.b	4		; Level
	dc.b	$00, $00, $B4	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 002, 004, 002, 002, 003, 003, 003, 003, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 002, 004, 002, 002, 003, 003, 003, 002, $10 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 006, 016, 013, 020, 017, 025, 004, 011, $10 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 007, 016, 013, 020, 017, 025, 004, 011, $10 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 001, 004, 002, 002, 003, 003, 003, 003, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 006, 016, 013, 020, 017, 025, 004, 011, $00 
	
	dc.b	25		; Level
	dc.b	$04, $AB, $6B	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 002, 004, 002, 002, 003, 003, 002, 002, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	003, 002, 004, 002, 002, 003, 003, 002, 002, $00 
	
	dc.b	50		; Level
	dc.b	$70, $22, $EE	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	004, 001, 004, 002, 002, 003, 003, 002, 002, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	016, 008, 015, 010, 014, 011, 008, 008, 008, $20 
	
	dc.b	2		; Level
	dc.b	$00, $00, $21	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 002, 003, 002, 002, 003, 003, 002, 002, $00 
	
	dc.b	3		; Level
	dc.b	$00, $00, $5D	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 003, 003, 002, 002, 003, 003, 002, 003, $00 
	
	dc.b	4		; Level
	dc.b	$00, $00, $BF	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 002, 003, 002, 002, 003, 003, 003, 002, $10 
	
	dc.b	5		; Level
	dc.b	$00, $01, $45	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 003, 003, 002, 002, 003, 003, 002, 002, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 012, 018, 015, 012, 018, 017, 007, 007, $20 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 002, 003, 002, 002, 003, 003, 003, 002, $10 
	
	dc.b	10		; Level
	dc.b	$00, $0C, $DA	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 003, 003, 002, 002, 003, 003, 002, 002, $20 
	
	dc.b	11		; Level
	dc.b	$00, $13, $3D	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 002, 003, 002, 002, 003, 003, 002, 003, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 011, 018, 015, 012, 018, 017, 007, 007, $10 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 002, 003, 002, 002, 003, 003, 003, 004, $00 
	
	dc.b	17		; Level
	dc.b	$00, $C3, $89	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 003, 003, 002, 002, 003, 003, 002, 002, $10 
	
	dc.b	18		; Level
	dc.b	$01, $1D, $40	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 002, 003, 002, 002, 003, 003, 003, 003, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 003, 003, 002, 002, 003, 003, 003, 002, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 002, 003, 002, 002, 003, 003, 003, 002, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 002, 003, 002, 002, 003, 003, 003, 004, $10 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 003, 003, 002, 002, 003, 003, 003, 003, $00 
	
	dc.b	28		; Level
	dc.b	$07, $CB, $11	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 011, 018, 015, 012, 018, 017, 009, 007, $10 
	
	dc.b	29		; Level
	dc.b	$08, $E8, $D9	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 003, 003, 002, 002, 003, 003, 002, 004, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 002, 003, 002, 002, 003, 003, 002, 003, $10 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 002, 003, 002, 002, 003, 003, 002, 004, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 011, 018, 015, 012, 018, 017, 009, 007, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 002, 003, 002, 002, 003, 003, 002, 004, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 003, 003, 002, 002, 003, 003, 003, 002, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	007, 012, 018, 015, 012, 018, 017, 009, 007, $00 
	
	dc.b	50		; Level
	dc.b	$76, $F7, $2E	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	003, 002, 003, 002, 002, 003, 003, 002, 003, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	013, 006, 018, 010, 015, 012, 018, 009, 009, $10 
	
	dc.b	2		; Level
	dc.b	$00, $00, $21	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	003, 002, 003, 002, 004, 002, 003, 002, 003, $00 
	
	dc.b	3		; Level
	dc.b	$00, $00, $55	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	005, 003, 007, 003, 006, 006, 006, 003, 004, $00 
	
	dc.b	4		; Level
	dc.b	$00, $00, $AF	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	010, 002, 003, 002, 004, 002, 003, 002, 003, $00 
	
	dc.b	5		; Level
	dc.b	$00, $01, $2A	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	004, 002, 003, 002, 004, 002, 003, 005, 003, $00 
	
	dc.b	6		; Level
	dc.b	$00, $02, $07	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 002, 007, 003, 006, 006, 006, 004, 004, $01 
	
	dc.b	7		; Level
	dc.b	$00, $03, $40	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	008, 002, 003, 002, 004, 002, 003, 003, 003, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	005, 003, 007, 003, 006, 006, 006, 003, 004, $01 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	002, 002, 003, 002, 004, 002, 003, 003, 003, $00 
	
	dc.b	12		; Level
	dc.b	$00, $1A, $2B	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	008, 002, 007, 003, 006, 006, 006, 004, 004, $11 
	
	dc.b	13		; Level
	dc.b	$00, $26, $B6	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	008, 002, 003, 002, 004, 002, 003, 002, 003, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	005, 003, 007, 003, 006, 006, 006, 003, 004, $10 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	002, 002, 003, 002, 004, 002, 003, 002, 003, $00 
	
	dc.b	18		; Level
	dc.b	$01, $05, $0B	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	008, 002, 007, 003, 006, 006, 006, 004, 004, $10 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	004, 002, 003, 002, 004, 002, 003, 002, 003, $00 
	
	dc.b	21		; Level
	dc.b	$02, $2B, $AF	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	008, 003, 007, 003, 006, 006, 006, 004, 004, $00 
	
	dc.b	22		; Level
	dc.b	$02, $A4, $80	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 002, 003, 002, 004, 002, 003, 005, 003, $00 
	
	dc.b	23		; Level
	dc.b	$03, $31, $AD	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	002, 002, 003, 002, 004, 002, 003, 001, 003, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 003, 007, 003, 006, 006, 006, 003, 004, $10 
	
	dc.b	28		; Level
	dc.b	$07, $21, $C5	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	008, 002, 003, 002, 004, 002, 003, 004, 003, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	005, 002, 007, 003, 006, 006, 006, 004, 004, $11 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	008, 003, 007, 003, 006, 006, 006, 003, 004, $10 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	003, 002, 003, 002, 004, 002, 003, 004, 003, $00 
	
	dc.b	36		; Level
	dc.b	$13, $AB, $9A	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	005, 002, 007, 003, 006, 006, 006, 004, 004, $10 
	
	dc.b	37		; Level
	dc.b	$16, $3A, $3A	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	010, 002, 004, 002, 004, 002, 003, 003, 003, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	006, 003, 006, 003, 006, 006, 006, 003, 004, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	005, 002, 003, 002, 004, 002, 003, 003, 003, $00 
	
	dc.b	42		; Level
	dc.b	$28, $F3, $E1	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	010, 002, 007, 003, 006, 006, 006, 004, 004, $00 
	
	dc.b	43		; Level
	dc.b	$2E, $46, $C8	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	003, 002, 003, 002, 004, 002, 003, 001, 003, $00 
...
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	004, 002, 003, 002, 004, 002, 003, 001, 003, $00 
	
	dc.b	48		; Level
	dc.b	$55, $42, $EE	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	004, 002, 007, 003, 006, 006, 006, 004, 004, $00 
	
	dc.b	49		; Level
	dc.b	$60, $58, $6E	; Experience points
	
;		HP   TP   STR  MEN  AGI  LUCK DEX  ATK  DEF
	dc.b	010, 002, 003, 002, 004, 002, 003, 001, 003, $00 
